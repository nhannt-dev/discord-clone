                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem className='uppercase text-xs font-bold text-zinc-500 dark:text-secondary/70'>
                                        ...
                                        <FormControl>
                                            <Input {...field} disabled={isLoading} placeholder='Enter channel name' className='bg-zinc-300/50 border-0 focus-visible:ring-0 text-black focus-visible:ring-offset-0' />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
